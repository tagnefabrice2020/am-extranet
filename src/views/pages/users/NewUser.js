...
const NewUser = ({ storeUser, users }) => {
    ...
    const newUser = (data) => {
        if (data.role === "2") data = { ...data, trigramme: data.prenom.substr(0, 1).toUpperCase() + data.nom.substr(0, 1).toUpperCase() }
        storeUser(data);
    }
                                        ...
                                        <div className="row">
                                            <div className="col">
                                                <div className="form-group">
                                                    ...
                                                    <input
                                                        type="text"
                                                        className={"form-control " + (errors.login && ` is-border-red`)}
                                                        placeholder="Le login"
                                                        {...register('login')}
                                                    />
                                                    {errors.login && <small className="form-text is-red">{errors.login.message}</small>}
                                                </div>
                                            </div>
                                            <div className="col">
                                                <div className="form-group">
                                        ...
                                        <div className="row">
                                            <div className="col">
                                                <div className="form-group">
                                                    ...
                                                    <input
                                                        type="text"
                                                        className={"form-control " + (errors.adresse && `is-border-red`)}
                                                        placeholder="Entre votre adresse"
                                                        {...register('adresse')}
                                                    />
                                                    {errors.adresse && <small className="form-text is-red">{errors.adresse.message}</small>}
                                                </div>
                                            </div>
                                            <div className="col"> <div className="form-group">
                                                ...
                                                <input
                                                    type="text"
                                                    className={"form-control " + (errors.telephone && `is-border-red`)}
                                                    placeholder="Entre le numéro de telephone"
                                                    {...register('telephone')}
                                                />
                                                {errors.telephone && <small className="form-text is-red">{errors.telephone.message}</small>}
                                            </div>
                                            </div>
                                        </div>
                                        <div className="form-group">
                                            ...
                                            <input
                                                type="password"
                                                className={"form-control " + (errors.mdp && `is-border-red`)}
                                                placeholder="Entre le mdp"
                                                {...register('mdp')}
                                            />
                                            {errors.mdp && <small className="form-text is-red">{errors.mdp.message}</small>}
                                        </div>
