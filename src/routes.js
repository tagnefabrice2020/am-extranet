...
const EditAdministrator = lazy(() => import('./views/pages/users/EditAdministrator'));
...
const routes = [
    ...
    {path: '/modifier/:uuid/administrateur/utilisateur', auth: true, name: 'Modifier un administrateur', element: EditAdministrator},
    {path: '/modifier/:uuid/agent/utilisateur', auth: true, name: 'Modifier un agent', element: EditAgent},
    {path: '/modifier/:uuid/client/utilisateur', auth: true, name: 'Modifier un client', element: EditClient},
    {path: '/modifier/:uuid/salarie/utilisateur', auth: true, name: 'Modifier un Salarié', element: EditSalarie},
